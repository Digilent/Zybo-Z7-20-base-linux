...
module system_v_frmbuf_wr_0_0_AXIvideo2MultiPixStr (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    ap_reg_grp_reg_unsigned_short_s_fu_369_ap_start;
reg    ap_block_state1_ignore_call17;
reg    ap_reg_grp_reg_unsigned_short_s_fu_375_ap_start;
...
#0 ap_reg_grp_reg_unsigned_short_s_fu_369_ap_start = 1'b0;
#0 ap_reg_grp_reg_unsigned_short_s_fu_375_ap_start = 1'b0;
end

system_v_frmbuf_wr_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_369(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_frmbuf_wr_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_375(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_reg_unsigned_short_s_fu_369_ap_start <= 1'b0;
    end else begin
        if ((~((1'b0 == HwReg_height_cast5_loc_out_full_n) | (1'b0 == HwReg_height_cast5_loc_empty_n) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_reg_grp_reg_unsigned_short_s_fu_369_ap_start <= 1'b1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_reg_unsigned_short_s_fu_375_ap_start <= 1'b0;
    end else begin
        if ((~((1'b0 == HwReg_height_cast5_loc_out_full_n) | (1'b0 == HwReg_height_cast5_loc_empty_n) | (real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_reg_grp_reg_unsigned_short_s_fu_375_ap_start <= 1'b1;
...
assign grp_reg_unsigned_short_s_fu_369_ap_start = ap_reg_grp_reg_unsigned_short_s_fu_369_ap_start;

assign grp_reg_unsigned_short_s_fu_375_ap_start = ap_reg_grp_reg_unsigned_short_s_fu_375_ap_start;
...
endmodule //system_v_frmbuf_wr_0_0_AXIvideo2MultiPixStr
